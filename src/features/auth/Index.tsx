...
const LoginForm: React.FC = () => {
  const userLoginlistData = [
    ...
    {
      lable: "Legel Rep User 2",
      data: {
        File_Number: "",
        UserID: "1078261540",
        UserName: "Legel Rep User 2",
        UserDOB: "22/08/1992",
        AcceptedLanguage: LanguageArray[1].value,
        UserType: userTypes[1].value,
      },
    ...
    {
      lable: "Worker Agent User Mandate And Pleintiff",
      data: {
        File_Number: "",
        UserDOB: "26/10/1965",
        UserID: "1003489059",
        MandateNumber: "464869324",
        Plaintiff_id: "2506230438",
        UserName: "Agent User",
        AcceptedLanguage: LanguageArray[1].value,
        UserType: userTypes[1].value,
      },
    ...
    {
      lable: "Worker Agent User 33",
      data: {
        File_Number: "",
        UserDOB: "13/09/1984",
        UserID: "1028308656",
        MandateNumber: "431898068",
        UserName: "Agent User",
        AcceptedLanguage: LanguageArray[1].value,
        UserType: userTypes[1].value,
      },
    ...
    {
      lable: "Esablishment User With Region And City",
      data: {
        File_Number: "1-356818",
        UserDOB: "05/11/1985",
    ...
    {
      lable: "Esablishment User No Data",
      data: {
        File_Number: "1-1765628",
        UserDOB: "25/10/1993",
        UserID: "1083610053",
        UserName: "Est User",
        AcceptedLanguage: LanguageArray[1].value,
      ...
      <section className="container m-auto min-h-screen flex justify-center items-center">
        <div className="shadow-3 card mx-auto mt-10 p-10 max-w-lg shadow-lg rounded-lg bg-white flex flex-col gap-10">
          ...
          <FormWrapper isValid={!isLoading} onSubmit={handleSubmit}>
            ...
            <p className="text-red-500 text-center">
              In Worker User , Delete File Number
            </p>
