...
import { toWesternDigits, isHijriDateInFuture } from "@/utils/helpers";
...
export const usePlaintiffFormLayout = (): SectionLayout[] => {
  ...
  const agencyType = watch("certifiedAgency");
  const agentId = watch("agentId");
  const mandateNumber = watch("agentMandateNumber");
  ...
  register("plaintiffId", {
    validate: (value) => value !== agentId || t("error.plaintiffSameAsAgent"),
  });
          ...
          children: [
            ...
            ...(isNicSuccess && nicData
              ? [
                  ...
                  },
                  {
                    ...
                    onChange: (value: any) =>
                      setValue("plaintiffRegion", value),
                  },
                  {
                    type: "autocomplete" as const,
                    name: "plaintiffCity",
                  ...
                  },
                  {
                    ...
                    value: nicData?.NICDetails?.Occupation
                      ...
                      : watch("plaintiffOccupation"),
                    onChange: (value: any) =>
                      setValue("plaintiffOccupation", value),
                  },
                  {
                    type: "autocomplete" as const,
                    ...
                    value: nicData?.NICDetails?.Gender
                      ...
                      : watch("plaintiffGender"),
                    onChange: (value: any) =>
                      setValue("plaintiffGender", value),
                  },
                  {
                    type: "autocomplete" as const,
                    ...
                    value: nicData?.NICDetails?.Nationality
                      ...
                      : watch("plaintiffNationality"),
                    onChange: (value: any) =>
                      setValue("plaintiffNationality", value),
                  },
                ]
              : [
                  {
                ...
                ]),
            {
              ...
              onChange: (value: boolean) =>
                setValue("plaintiffUseIntlPhone", value),
            },
            ...(useIntlPhone
              ? [
                  {
                    ...
                    onChange: (value: any) =>
                      setValue("plaintiffCountryCode", value),
                  },
                  {
                    type: "input" as const,
                    ...
                    onChange: (value: string) =>
                      setValue("plaintiffMobileIntl", value),
                  },
                  {
                    type: "input" as const,
                    name: "plaintiffOtp",
