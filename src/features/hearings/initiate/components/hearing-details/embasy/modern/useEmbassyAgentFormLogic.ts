...
import { useLazyGetNICDetailsForEmbasyQuery } from "@/features/hearings/initiate/api/create-case/plaintiffDetailsApis";
import { isHijriDateInFuture } from "@/utils/helpers";
