...
import { NICDetailsResponse } from "@/features/hearings/initiate/api/create-case/plaintiffDetailsApis";
import AddAttachment from "../../../add-attachments";
import OTPFormLayout from "./OTP.froms.formlayout";
import { formatDateString, formatDateToYYYYMMDD } from "@/utils/helpers";
