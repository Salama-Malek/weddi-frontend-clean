...
} from "@/features/hearings/initiate/hoc/with-step-navigation";
import {
  useGetAcknowledgementQuery,
  useLazyGetFileDetailsQuery,
} from "../../api/create-case/apis";
import { useGetCaseDetailsQuery } from "@/features/hearings/manage/api/myCasesApis";
...
const ReviewDetails = ({
      ...
      ? [
          {
            ...
            data: {
              ...
              options: [
                {
                  label: hearingdetails("nonGovernmentalEntities"),
                  value: "Establishment",
                },
                { label: t("governmentEntities"), value: "Government" },
              ],
      ...
      : [
          {
            ...
            data: {
              ...
              label: t("Defendant's Type:"),
              options: [
                { label: t("nonGovernmentalEntities"), value: "Establishment" },
                { label: t("governmentEntities"), value: "Government" },
              ],
              value: details?.DefendantType_Code || "",
              onChange: () => {},
  ...
  const DefendentWorkerSection: ReviewSection[] = [
    {
      title: t("defendantDetails"),
      data: {
        type: "readonly",
  ...
  const TopicsAndAttachments: ReviewSection[] = [
    {
    ...
    },
    {
      ...
      data: {
        ...
        files: [
          ...
          fileName:
            ensureFileNameWithExtension(f.FileName, f.FileType) ||
            "Unnamed File",
          fileKey: f.FileKey,
        })),
      },
  ...
  const WorkDetailsAndLocationsAsClaiment: ReviewSection[] = [
    {
      title: t("workDetails"),
      data: {
        type: "readonly",
  ...
  const WorkDetailsAndLocationsAsDeffendent: ReviewSection[] = [
    {
      title: t("workDetails"),
      data: {
        type: "readonly",
  ...
  const reviewSections: ReviewSection[] = [
    ...
    ...defSection,
    ...WorkDetailsAndLocationsAsClaiment,
    ...TopicsAndAttachments,
  ];
  ...
  const reviewSectionLegRep: ReviewSection[] = [
    ...
    ...DefendentWorkerSection,
    ...WorkDetailsAndLocationsAsDeffendent,
    ...TopicsAndAttachments,
  ];
        ...
        <Section
          ...
          className={`${
            data.type === "radio" || data.type === "table"
              ...
              : "grid grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6"
          }`}
        >
          {data.type === "radio" && (
            <RadioGroup
