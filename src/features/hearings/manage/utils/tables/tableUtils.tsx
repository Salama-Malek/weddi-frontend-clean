...
export function StatusCell({ status }: StatusCellProps) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 sm:gap-2 rounded-full text-xs sm:text-sm semibold ${classes} px-2 sm:px-[8px] py-[7px] min-w-0`}
    >
