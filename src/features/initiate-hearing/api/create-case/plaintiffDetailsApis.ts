...
//     GetWorkerRegionLookupData: builder.query<any, { AcceptedLanguage: string; SourceSystem: string }>({
...
//     GetWorkerCityLookupData: builder.query<any, { AcceptedLanguage: string; SourceSystem: string; selectedWorkerRegion: { value: string } }>({
//       query: ({ AcceptedLanguage, SourceSystem, selectedWorkerRegion }) => ({
//         url: `/WeddiServices/V1/SubLookup`,
//         params: {
//           LookupType: "CaseElements",
//           ModuleKey: selectedWorkerRegion.value,
//           ModuleName: "City",
//           AcceptedLanguage,
//           SourceSystem,
//         },
...
//     GetLaborOfficeLookupData: builder.query<any, { AcceptedLanguage: string; SourceSystem: string; selectedWorkerCity: { value: string } }>({
//       query: ({ AcceptedLanguage, SourceSystem, selectedWorkerCity }) => ({
//         url: `/WeddiServices/V1/SubLookup`,
//         params: {
//           LookupType: "CaseElements",
//           ModuleKey: selectedWorkerCity.value,
...
//         params: {
//           LookupType: "CaseElements",
//           ModuleKey: "LabourOffice",
//           ModuleName: "LabourOffice",
//           AcceptedLanguage,
//           SourceSystem,
//         },
//       }),
