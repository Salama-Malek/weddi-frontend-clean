...
const getBasePayload = (
    ...
    if (lowUserType === 'worker' || lowUserType === 'agent' || userType === "embassy user") {
...
export const claimantDetailsPayload = (
    ...
    console.log("userType", lowUserType);
    console.log("this is fembasy Payload Fun  ", emabsyClaimantPayload(
        buttonName, formData, userClaims, userType, caseId, language));
    return {}
...
const emabsyClaimantPayload = (
    ...
    console.log("this is form embasy as agent ", formData);
    console.log("this is frim embasy  ", formData?.claimantStatus);
    ...
    /**
    {
      ...
      "userName": " عبدالله عبدالرحمن مهنا المهنا",
      "region": {
          "value": "1",
          "label": "Riyadh"
      },
      ...
      "hijriDate": "14060224",
      "gregorianDate": "19851107",
      "applicant": "",
      "phoneNumber": "0512345678",
      "Agent_EmbassyName": "سفارة مصر",
      "Agent_EmbassyNationality": "مصر",
      "Agent_EmbassyPhone": "0545280285",
      "Agent_EmbassyFirstLanguage": "اليمن",
      "Agent_EmbassyEmailAddress": "test@gmail.com",
      "interPhoneNumber": "",
      "isPhone": false,
      "idNumber": "1022190118"
  }
    ...
    if (formData?.claimantStatus === "principal") {
        return {
            ...
            PlaintiffId: "2222252222",
            PlaintiffHijiriDOB: "13891023",
            Plaintiff_ApplicantBirthDate: "19990505",
            PlaintiffName: "Ahmed",
            DomesticWorker: "",
            Worker_Nationality: "307",
            Gender: "GD1",
            JobPracticing: "OUP-1003",
            IsGNRequired: "",
            CountryCode: "",
            GlobalPhoneNumber: "",
            IsGNOtpVerified: "",
            Plaintiff_PhoneNumber: "0566778899",
            Plaintiff_Region: "1",
            Plaintiff_City: "1"
    ...
    return {
        ...
        CaseID: getCaseId,
        Flow_CurrentScreen: "PlaintiffDetails",
        Agent_EmbassyName: formData?.Agent_EmbassyName,
        Agent_EmbassyNationality: formData?.Agent_EmbassyNationality,
        Agent_EmbassyPhone: formData?.Agent_EmbassyPhoneNumber,
        Agent_EmbassyEmailAddress: formData?.Agent_EmbassyEmail,
        Agent_EmbassyFirstLanguage: formData?.Agent_EmbassyFirstLanguage,
        Plaintiff_EmbassyAddress: formData?.Agent_EmbassyAddress,
        ApplicantType: "Worker",
        PlaintiffType: "Agent",

        PlaintiffId: "2555073921",
        PlaintiffHijiriDOB: "13891023",
        Plaintiff_ApplicantBirthDate: "19990405",
        PlaintiffName: "Ahmed",
        DomesticWorker: "",
        Worker_Nationality: "307",
        Gender: "GD1",
