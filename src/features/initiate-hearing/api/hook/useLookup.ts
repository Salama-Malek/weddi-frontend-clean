import {
  ...
  useSubLookupQuery,
} from "../create-case/addHearingApis";
...
export const useLookup = () => {
  ...
  return {
      ...
      useGenericLookupQuery(
        {
          ...
          ApplicantType:
            userType === UserTypesEnum.WORKER ||
            userType === UserTypesEnum.EMBASSY
              ? userType
              : UserTypesEnum.ESTABLISHMENT,
      ...
      useSubLookupQuery(
        {
          ...
          SourceSystem: "E-Services",
          AcceptedLanguage: currentLanguage,
          ...(extraParams?.PlaintiffID
            ? { PlaintiffID: extraParams.PlaintiffID }
            : {}),
          ...(extraParams?.Number700
            ? { Number700: extraParams.Number700 }
            : {}),
          ...(extraParams?.DefendantType
    ...
    establishmentCity: () =>
      useGetEstablishmentCityLookupQuery({
        LookupType: "CaseElements",
        ModuleKey: "22",
    ...
    jobLocationCity: () =>
      useGetJobLocationCityLookupQuery({
        LookupType: "CaseElements",
        ModuleKey: "01",
    ...
    payIncreaseType: (subCategoryValue: string | undefined) =>
      useGenericLookupQuery(
        {
          LookupType: "DataElements",
          ModuleKey: "PIT",
