  ...
  if (applicantType === "Agent") {
    ...
    if (agencyType === "localAgency") {
      return [
        ...
        // build agent info section using shared layout
        buildAgentInformationSection(agentFields, watch, setValue, t),
        {
    ...
    return [
      ...
      // shared agent info section
      buildAgentInformationSection(
        agentFields,
        watch,
        setValue,
        t,
