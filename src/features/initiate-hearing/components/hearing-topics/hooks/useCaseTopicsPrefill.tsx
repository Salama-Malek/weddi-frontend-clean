...
const useCaseTopicsPrefill = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Special debugging for EDO topics
      if (editTopic.SubTopicID && editTopic.SubTopicID.startsWith('EDO')) {
        console.log('EDO Topic Debug:', {
          subTopicID: editTopic.SubTopicID,
          originalTopic: editTopic,
          extractedFields: formFields,
          managerialDateFields: {
            hijri: formFields.managerial_decision_date_hijri,
            gregorian: formFields.managerial_decision_date_gregorian,
            number: formFields.managerialDecisionNumber
          }
        });
      }
