...
export const claimantColumns: ColumnDef<Hearing, any>[] = [
  columnHelper.accessor("requestNumber", {
    header: () => (
      <span className="text-xs sm:text-sm md:text-md font-bold text-gray-700">
        Request Number
      </span>
    ),
    cell: (info) => (
  ...
  columnHelper.accessor("hearingNumber", {
    header: () => (
      <span className="text-xs sm:text-sm md:text-md medium text-gray-700">
        Hearing Number
      </span>
    ),
    cell: (info) => (
  ...
  columnHelper.accessor("defendantName", {
    header: () => (
      <span className="text-xs medium text-gray-700">Defendant’s Name</span>
    ),
    cell: (info) => (
      <span className="text-md normal text-gray-700">
        {truncateText(info.getValue(), 12)}
  ...
  columnHelper.accessor("hearingDate", {
    header: () => (
      <span className="text-xs medium text-gray-700">Hearing Date</span>
    ),
    cell: (info) => (
  ...
  columnHelper.accessor("sessionTiming", {
    header: () => (
      <span className="text-xs medium text-gray-700">Session Timing</span>
    ),
    cell: (info) => (
  ...
  columnHelper.accessor("hearingStatus", {
    header: () => (
      <span className="text-xs medium text-gray-700">Hearing Status</span>
    ),
    cell: (info) => {
  ...
  {
    id: "actions",
    header: () => <span className="text-xs medium text-gray-700">Actions</span>,
    cell: ({ row }) => (
      //@ts-ignore
      <ActionsCell
...
export const defendantColumns: ColumnDef<Hearing, any>[] = [
  columnHelper.accessor("requestNumber", {
    header: () => (
      <span className="text-xs medium text-gray-700">Request Number</span>
    ),
    cell: (info) => (
      <span className="text-md normal text-gray-700">
        {truncateText(info.getValue(), 12)}
  ...
  columnHelper.accessor("hearingNumber", {
    header: () => (
      <span className="text-xs medium text-gray-700">Hearing Number</span>
    ),
    cell: (info) => (
      <span className="text-md normal text-gray-700">
        {truncateText(info.getValue(), 12)}
