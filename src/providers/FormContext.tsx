...
export const FormProvider: React.FC<FormProviderProps> = ({
  ...
  React.useEffect(() => {
    const handleCaseCleared = () => {
      formMethods.reset(mergedDefaults as any, { keepErrors: false });
    };
    window.addEventListener("caseDataCleared", handleCaseCleared as any);
    return () =>
      window.removeEventListener("caseDataCleared", handleCaseCleared as any);
  }, [formMethods.reset, mergedDefaults]);
