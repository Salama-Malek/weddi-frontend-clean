...
> = ({ items, selected, onSelect, onChange, languageChange }) => {
  ...
  return (
    <div className="relative">
      <ul
        className={`absolute ${isRTL ? "left-0" : "right-0"} z-50 mt-2 w-56 origin-top-right bg-white ring-1 shadow-md ring-black/5 transition b-radius p-2 overflow-y-auto`}
      >
        {items.map((item, idx) => (
          <li
            key={idx}
