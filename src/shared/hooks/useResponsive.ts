...
type Breakpoint = 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl' | '6xl' | '7xl' | '8xl';
...
export const useResponsive = () => {
    ...
    const isUltraWide = currentBreakpoint === '4xl' || currentBreakpoint === '5xl' || currentBreakpoint === '6xl' || currentBreakpoint === '7xl' || currentBreakpoint === '8xl';
